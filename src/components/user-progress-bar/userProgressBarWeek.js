...
export default function UserProgressBarWeek(props) {
    ...
    function configureProgressBar() {
        ...
        let percentOfBar = ((seconds * (width * 0.85)) / 54000);
    ...
    return (
        <View style={styles.progressBarComponentContainer}>
            <View style={styles.informationContainerText}>
                <Text style={styles.barTitle}>Sua semana</Text>
                <Text style={styles.barDayHourProgress} >{hourSum} / 15:00</Text>
            </View>
